  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-20 right-20 w-96 h-96 bg-cyan-400/20 rounded-full blur-2xl animate-float"
          style={{ animationDelay: "-2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/3 w-64 h-64 bg-blue-400/20 rounded-full blur-xl animate-float"
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-12 max-w-3xl mx-auto leading-relaxed">
            Transforming ideas into scalable applications with 7+ years of
            experience in React, TypeScript, and cloud architecture. Leading
            teams while building innovative solutions that serve 50,000+
            concurrent users.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              onClick={scrollToContact}
              className="group px-8 py-4 bg-white text-blue-600 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
            >
              Get In Touch
